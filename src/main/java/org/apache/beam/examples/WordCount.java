...
import org.apache.beam.sdk.metrics.MetricsEnvironment;//追加
...
public class WordCount {
  ...
  public static class CountWords
    ...
    public PCollection<KV<String, Long>> expand(PCollection<String> lines) {
      ...
      System.out.println("出力"+words.getClass().getSimpleName());//
  ...
  public interface WordCountOptions extends PipelineOptions {
    ...
    //追加　[project_id]:[dataset_id].[table_id]
    //追加　bigquery-public-data:usa_names.usa_1910_2013
    String tableSpec = "bigquery-public-data:usa_names.usa_1910_2013";//追加

    @Description("Path of the file to read from")
    //@Default.String("gs://apache-beam-samples/shakespeare/kinglear.txt")
    @Default.String(tableSpec)
    //対象 bigquery-public-data:usa_names.usa_1910_current
    String getInputFile();
